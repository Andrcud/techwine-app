...
/* ─── 3. ЛЕТУЧАЯ КИСЛОТНОСТЬ ───────────────────────────────────── */
{
  ...
  branches: [
    ...
    { when: { ru: "ЛК 0,7–0,9 г/л", en: "VA 0.7–0.9 g/L", ro: "AV 0,7–0,9 g/L" },
      lvl: "bad",
      act: { ru: "Близко к пределу. Убрать бактерии физически: тангенциальная (кроссфлоу) фильтрация — она снимает уксуснокислые бактерии из вина. Затем SO₂ по pH, изоляция партии, купаж с вином низкой ЛК. Химически саму уксусную кислоту не убрать.",
             en: "Close to the legal limit. Remove the bacteria physically: crossflow filtration strips acetic bacteria from the wine. Then SO₂ per pH, isolate the batch, blend with a low-VA wine. The acetic acid itself cannot be removed chemically.",
             ro: "Aproape de limită. Eliminați bacteriile fizic: filtrarea tangențială (crossflow) îndepărtează bacteriile acetice. Apoi SO₂ după pH, izolați lotul, cupajați cu vin cu AV mică." },
      products: ["METABISOLFITO DI K (порошок)", "SOLFITAN® 63"] },

    { when: { ru: "ЛК > 0,9 г/л", en: "VA > 0.9 g/L", ro: "AV > 0,9 g/L" },
      lvl: "bad",
      act: { ru: "Пределы ЕС: около 1,08 г/л (белые) и 1,2 г/л (красные) — уточнить по своему регламенту. При ЛК выше 1 г/л вино не списывают: TechWine выполняет УДАЛЕНИЕ УКСУСНОЙ КИСЛОТЫ НА ОБОРУДОВАНИИ (мембранная технология) — свяжитесь с нами, партию можно спасти. Параллельно: изолировать ёмкость и продезинфицировать оборудование.",
             en: "EU limits are roughly 1.08 g/L (whites) and 1.2 g/L (reds) — confirm against your own regulation. Above 1 g/L the wine need not be written off: TechWine performs ACETIC ACID REMOVAL BY MACHINE (membrane technology) — contact us, the batch can be saved. In parallel: isolate the tank and disinfect the equipment.",
             ro: "Limitele UE: cca 1,08 g/L (albe) și 1,2 g/L (roșii). Peste 1 g/L vinul nu se casează: TechWine efectuează ELIMINAREA ACIDULUI ACETIC PE INSTALAȚIE (tehnologie membranară) — contactați-ne, lotul poate fi salvat. În paralel: izolați cisterna și dezinfectați echipamentul." },
      products: ["BIOCIDA V", "BLASTOKILL"] }
  ],
  so2table: true,
  equip: ["app_mftc", "app_mmf_hybrid", "app_mmf", "app_mastermind_remove"],
  prevent: {
    ru: ["Полные ёмкости — главное правило против уксусных бактерий",
         ...
         "Кроссфлоу-фильтрация убирает бактерии до того, как ЛК вырастет"],
    en: ["Full tanks — the number one rule against acetic bacteria",
         ...
         "Crossflow filtration removes the bacteria before VA climbs"],
    ro: ["Cisterne pline — regula nr. 1 împotriva bacteriilor acetice",
         ...
         "Filtrarea crossflow elimină bacteriile înainte ca AV să crească"]
  }
},
